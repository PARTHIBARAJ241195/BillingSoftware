					...
					<tr>
						<td>
							<div class="form-group form-group-sm  no-margin-bottom">
								...
								<input type="text" class="form-control form-group-sm item-input invoice_product required" style="width:90%" name="invoice_product[]" placeholder="Enter Product Name OR Description">
								<p class="item-select">or <a href="#">select a product</a></p>
							</div>
						</td>
						<td class="text-right">
							<div class="form-group form-group-sm no-margin-bottom">
								<input type="number" class="form-control invoice_product_area calculate required" name="invoice_product_qty[]">
							</div>
						</td>
						<td class="text-right">
						...
						<td class="text-right">
							<div class="input-group input-group-sm  no-margin-bottom">
								<span class="input-group-addon"><?php echo CURRENCY ?></span>
								<input type="number" class="form-control calculate invoice_product_total_price required" name="invoice_product_total_price[]" aria-describedby="sizing-addon1" placeholder="0.00" disabled>
							</div>
						</td>
						<td class="text-right">
							<div class="form-group form-group-sm  no-margin-bottom">
			...
			<div id="invoice_totals" class="padding-right row text-right">
				<div class="col-xs-6">
					<div class="input-group form-group-sm textarea no-margin-bottom">
						<textarea name="invoice_notes" placeholder="Additional Notes..."><?php echo TERMSANDCONDS ?></textarea>
					</div>
				...
				<div class="col-xs-6 no-padding-right">
					...
					<div class="col-xs-6" style ="margin-right: 1%;">
